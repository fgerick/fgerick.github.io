...
# ╔═╡ 1740f052-7ed6-4316-a046-f0ea1ef6689e
using Luxor

# ╔═╡ 66c80b85-54d6-46e2-8bc3-8b12b408293d
using Colors

# ╔═╡ dae75b28-070c-479b-b788-08a9403e8132
using ColorSchemes

# ╔═╡ b400272a-e57d-11ef-2fa1-112989450a9a
let
	diameter = 96
	radius = diameter/2
	Drawing(diameter, diameter, "/Users/felixger/Downloads/favicon-gerick.png")
	origin()
	cmap = reverse(ColorSchemes.Reds_4)
	#surface
	setcolor(cmap[1])
	circle(Point(0, 0), radius, action = :fill)
	#mantle
	er = 6371
	mantlefac = 1 - 70/er
	setcolor(cmap[2])
	circle(Point(0, 0), radius*mantlefac, action = :fill)
	
	#outer core
	ocfac = 1-(70+2890)/er
	setcolor(cmap[3])
	circle(Point(0, 0), radius*ocfac, action = :fill)
	
	#inner core
	icfac = 1-(70+2890+2260)/er
	setcolor(cmap[4])
	circle(Point(0, 0), radius*icfac, action = :fill)
...
manifest_format = "2.0"
project_hash = "592ff325af17758a84845c18914d21a7daddda59"
